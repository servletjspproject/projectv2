...
public class IndexFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        List<Products> productses = productsHome.getLatestProducts(7);
        LatestProduct latestProduct = new LatestProduct();
        latestProduct.setProductses(productses);
       // HttpSession session = request1.getSession(true);
        request1.setAttribute("latestProduct", latestProduct);
