				  	...
				  	<h3>Category Information</h3>
					    <form method="post" action="contact-post.html">
					    	...
					    	<div>
						    	...
						    	<span>
									<label>
                        <input name="address" placeholder="i.e: Heals" type="text" tabindex="1" required="" autofocus="">
					</label>
								</span>
						    </div>
							
						    <div>
						    	<span><label>Available</label></span>
						    	<span>
									<label>
                        <input name="address" placeholder="Yes/No" type="text" tabindex="1" required="" autofocus="">
					</label>
