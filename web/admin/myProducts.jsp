    ...
    <head>
        ...
        <script type="text/javascript">
           function editProduct(id){
                 window.location.assign("ProductprofileAdmin.jsp?id="+id);
            ...
            <div class="wrap">
                <div class="main">
                    <div class="top_main">
                        ...
                        <table cellpadding="1" cellspacing="0" border="1" class="display" id="example" width="100%">
                            <thead>
                                <tr>
                        ...
                        <product:myProducts></product:myProducts>
